...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, RouterModule, NovaThemeTogglerComponent],
  template: `
    <div class="app-container" [class.sidenav-open]="sidenavOpen">
      ...
      <header class="app-header">
        ...
        <div class="header-actions">
          <a
            href="https://github.com/your-repo/nova-ui"
            target="_blank"
            class="github-link"
          >
...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  toggleSidenav(): void {
    ...
    // Force page reflow on desktop to ensure proper layout
    if (!this.isMobile) {
      setTimeout(() => {
